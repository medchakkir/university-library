  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden py-20 md:py-28">
        ...
        <div className="absolute -top-40 -left-40 h-80 w-80 rounded-full bg-primary/20 blur-[100px]" />
        <div className="absolute -right-40 top-40 h-80 w-80 rounded-full bg-blue-100/20 blur-[100px]" />
          ...
          <div className="flex flex-col items-center gap-8 md:flex-row md:justify-between">
            <div className="flex-1 text-center md:text-left">
              <h1 className="mb-6 text-4xl font-bold leading-tight tracking-tight text-white md:text-5xl lg:text-6xl">
                Your Gateway to <span className="text-primary">Infinite</span> Knowledge
              </h1>
              <p className="mb-8 text-lg text-light-100 md:max-w-md">
                Explore 10,000+ free e-books, audiobooks, and research papers—curated for curious minds.
              </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            <span className="mb-2 inline-block rounded-full bg-primary/20 px-4 py-1 text-sm font-medium text-primary">Features</span>
            <h2 className="text-3xl font-bold text-white md:text-4xl">Why Choose Our Library?</h2>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              ...
              >
                <div className="absolute -right-20 -top-20 h-40 w-40 rounded-full bg-primary/5 transition-all group-hover:bg-primary/10" />
      ...
      <section className="relative overflow-hidden py-20">
        ...
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            <span className="mb-2 inline-block rounded-full bg-primary/20 px-4 py-1 text-sm font-medium text-primary">Testimonials</span>
            <h2 className="text-3xl font-bold text-white md:text-4xl">What Readers Say</h2>
          </div>
          
          <div className="grid gap-8 md:grid-cols-3">
            {[
              {
                quote: "This library saved me hundreds on textbooks! The interface is clean and easy to navigate.",
                author: "Maria Johnson",
                role: "Computer Science Student",
                avatar: "https://i.pravatar.cc/100?img=1",
              },
              {
                quote: "The best collection of classics I've found online. The reading experience is smooth and enjoyable.",
                author: "James Wilson",
                role: "Book Club Organizer",
                avatar: "https://i.pravatar.cc/100?img=2",
              },
              {
                quote: "It was a game-changer for my studies. I can access all my research materials in one place.",
              ...
              >
                ...
                <p className="mb-4 text-light-100">&#34;{testimonial.quote}&#34;</p>
                <div className="flex">
                  {[1, 2, 3, 4, 5].map((star) => (
                    <svg
                      key={star}
